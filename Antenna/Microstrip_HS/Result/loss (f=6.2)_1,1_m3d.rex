...
<MetaResultFile creator="Solver HFTD - Field 3DFD Monitor" version="20170330">
  ...
  <SimulationProperties dB_Amplitude="10" encoded_unit="&amp;U:W^1.:m^-3" fieldname="&lt;name missing&gt;" fieldtype="Power Loss Density" frequency="6.1999998092651367188" label=""/>
  <MetaGeometryFile filename="model.gex" lod="1"/>
  <ResultGroups num_steps="1">
    <Frame index="0" tfo="loss (f=6.2)_1,1_m3d.tfo">
      <FieldResultFile filename="loss (f=6.2)_1,1.m3d" type="m3d"/>
    </Frame>
  </ResultGroups>
