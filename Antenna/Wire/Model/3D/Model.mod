...
Monitor.Delete "loss (f=1)" 
Monitor.Delete "loss (f=2)" 
Monitor.Delete "loss (f=3)" 
Monitor.Delete "power (f=1)" 
Monitor.Delete "power (f=2)" 
...
With FDSolver
     ...
     .AccuracyROM "1e-4" 
     .AddInactiveSampleInterval "3", "3", "1", "Single", "False" 
