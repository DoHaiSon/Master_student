...
ylabel=s:surface current (f=2) [1]
...
result=s:0
treepath=s:Farfields\farfield (f=2) [1]\farfield (f=2) [1]
files=s:farfield (f=2) [1].sig
xlabel=s:Theta / Degree
ylabel=s:dB
title=s:Farfield  Theta/Phi (Phi=90)
